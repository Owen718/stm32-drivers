	...
	while(*str!='\0') //连续显示
	{
		...
		else //显示中文
		{
			...
			switch(font)
			{
				...
				case 0xC4D6:addr=69;break;//闹
				case 0xD6D3:addr=70;break;//钟
				case 0xCAB1:addr=71;break;//时
				case 0xC4FA:addr=72;break;//您
				case 0xB5C4:addr=73;break;//的
				case 0xCCE5:addr=74;break;//体
				case 0xCEAA:addr=75;break;//为
				default : break;
			}
